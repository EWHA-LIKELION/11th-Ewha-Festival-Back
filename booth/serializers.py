...
class BoothListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booth
        fields = ['id', 'user', 'day', 'college', 'name', 'number', 'thumnail', 'open', 'hashtag', 'notice', 'is_liked', 'created_at', 'updated_at']
...
class BoothDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booth
        fields = ['id', 'user', 'day', 'college', 'name', 'number', 'thumnail', 'open', 'hashtag', 'notice', 'description', 'images', 'menus', 'is_liked', 'created_at', 'updated_at', 'comments']
